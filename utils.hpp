...
class String {
 ...
 public:
  ...
  String(const std::string &s) { strcpy(str, s.c_str()); }

  explicit operator const char *() { return str; }

  operator const std::string() { return std::string(str); }
  ...
  bool operator==(const String &rhs) const { return !strcmp(str, rhs.str); }

  bool operator!=(const String &rhs) const { return strcmp(str, rhs.str); }

  bool operator<(const String &rhs) const { return strcmp(str, rhs.str) < 0; }
